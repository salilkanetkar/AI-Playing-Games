...
struct SKillCamStreamData
{
	...
	ILINE bool UpdateValidationTimer( const float dt ) { if( m_validExpectationsTimer>0.f ) { m_validExpectationsTimer=(float)fsel(m_validExpectationsTimer-dt,m_validExpectationsTimer-dt,0.f); return m_validExpectationsTimer>0.f; } return true; }
