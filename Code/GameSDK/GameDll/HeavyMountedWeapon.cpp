...
DECLARE_DEFAULT_COMPONENT_FACTORY(CHeavyMountedWeapon, CHeavyMountedWeapon)
...
void CHeavyMountedWeapon::InitClient (ChannelId channelId)
{
...
//{
//	tSoundID result = 0;
//	IComponentAudio* pIComponentAudio = GetAudioProxy(true);
//	if (pIComponentAudio)
//	{
...
//		result = pIComponentAudio->PlaySoundEx(soundName.c_str(), ZERO, FORWARD_DIRECTION, FLAG_SOUND_DEFAULT_3D, 0, 1.0f, 0, 0, eSoundSemantic_Weapon);
//	}
//	return result;
//}
