...
/*
	...
	if (pAmmo)
	{
		...
		const float speedScale = (float)fsel(-GetShared()->fireparams.speed_override, 1.0f, GetShared()->fireparams.speed_override * fres(GetAmmoParams()->speed));
