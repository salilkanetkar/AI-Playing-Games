...
{
public:
	DECLARE_COMPONENT_TYPE("CGameRules",0xC16A58B0989F407F,0x830D1F3412ACED3A)
	...
	//IGameRules
	virtual bool ShouldKeepClient(ChannelId channelId, EDisconnectionCause cause, const char *desc) const;
	...
	virtual bool OnClientConnect(ChannelId channelId, bool isReset);
	virtual void OnClientDisconnect(ChannelId channelId, EDisconnectionCause cause, const char *desc, bool keepClient);
	virtual bool OnClientEnteredGame(ChannelId channelId, bool isReset);
	...
	virtual void SendTextMessage(ETextMessageType type, const char *msg, uint32 to=eRMI_ToAllClients, ChannelId channelId=-1,
	...
	virtual EntityId SetChannelForMigratingPlayer(const char* name, ChannelId channelID);
	...
	void SendNetConsoleCommand(const char *msg, unsigned int to, ChannelId channelId = -1);
#endif
	...
	void OnUserLeftLobby(ChannelId channelId);
	...
	IActor *GetActorByChannelId(ChannelId channelId) const;
	...
	//------------------------------------------------------------------------
	// player
	IActor *SpawnPlayer(ChannelId channelId, const char *name, const char *className, const Vec3 &pos, const Ang3 &angles);
	...
	bool IsChannelInGame(ChannelId channelId) const;
	...
	int GetChannelTeam(ChannelId channelId) const;
...
DECLARE_COMPONENT_POINTERS(CGameRules)
