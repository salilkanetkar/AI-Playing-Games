...
public:
	...
	DECLARE_COMPONENT_TYPE("CReplayActor", 0xF61AFB7D87B64AD6,0xA495821113ECA76D)
	...
	static CReplayActor *GetReplayActor(IEntity* pEntity)
	{
		if (pEntity)
		{
			if (CGameObject * pGameObject = (CGameObject*)pEntity->GetComponent<IComponentUser>().get())
			{
