...
void CEquipmentLoadout::OnClientConnect(ChannelId channelId, bool isReset, EntityId playerId)
{
	if (!isReset)
	{
...
void CEquipmentLoadout::OnClientDisconnect(ChannelId channelId, EntityId playerId)
{
...
void CEquipmentLoadout::SvSetClientLoadout(ChannelId channelId, const CGameRules::EquipmentLoadoutParams &params)
{
...
void CEquipmentLoadout::ClSendCurrentEquipmentLoadout(ChannelId channelId)
{
...
void CEquipmentLoadout::SvAssignClientEquipmentLoadout(ChannelId channelId, int playerId)
{
...
//------------------------------------------------------------------------
bool CEquipmentLoadout::SvHasClientEquipmentLoadout(ChannelId channelId)
{
	TClientEquipmentPackages::iterator it= m_clientLoadouts.find(channelId);
	if (it != m_clientLoadouts.end())
	{
...
//------------------------------------------------------------------------
void CEquipmentLoadout::SvRemoveClientEquipmentLoadout(ChannelId channelId)
{
	TClientEquipmentPackages::iterator it= m_clientLoadouts.find(channelId);
	if (it != m_clientLoadouts.end())
	{
