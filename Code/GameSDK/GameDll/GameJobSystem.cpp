...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
const AABB GameSDK::CLightningRenderNode::GetBBox() const
{
	if (m_dirtyBBox)
	{
...
///////////////////////////////////////////////////////////////////////////////
void GameSDK::CLightningRenderNode::FillBBox(AABB &aabb)
{ 
    aabb = GameSDK::CLightningRenderNode::GetBBox();
}

///////////////////////////////////////////////////////////////////////////////
EERType GameSDK::CLightningRenderNode::GetRenderNodeType()
{
	return eERType_GameEffect;
}

///////////////////////////////////////////////////////////////////////////////
float GameSDK::CLightningRenderNode::GetMaxViewDist()
{
...
///////////////////////////////////////////////////////////////////////////////
Vec3 GameSDK::CLightningRenderNode::GetPos(bool bWorldOnly) const
{
	return Vec3(ZERO);
}

///////////////////////////////////////////////////////////////////////////////
IMaterial* GameSDK::CLightningRenderNode::GetMaterial(Vec3* pHitPos)
{
	return m_pMaterial;
}
