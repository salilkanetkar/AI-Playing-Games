...
#if !defined(_LIB) || defined(IS_EAAS)
inline SUIItemLookupSet_Impl<SUIParameterDesc>* SUIItemLookupSetFactory::CreateLookupParameter() { return 0; } //assert(gEnv->pFlashUI); return Env->pFlashUI->CreateLookupParameter(); }
inline SUIItemLookupSet_Impl<SUIMovieClipDesc>* SUIItemLookupSetFactory::CreateLookupMovieClip() { return 0; } //assert(gEnv->pFlashUI); return gEnv->pFlashUI->CreateLookupMovieClip(); }
inline SUIItemLookupSet_Impl<SUIEventDesc>* SUIItemLookupSetFactory::CreateLookupEvent() { return 0; } //assert(gEnv->pFlashUI); return Env->pFlashUI->CreateLookupEvent(); }
#endif
