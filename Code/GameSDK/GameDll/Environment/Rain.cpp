...
//////////////////////////////////////////////////////////////////////////
class GameSDK_CFlowNode_RainProperties : public CFlowBaseNode<eNCT_Instanced>
{
public:
    GameSDK_CFlowNode_RainProperties(SActivationInfo * pActInfo)
	{
	}
	...
	{
        return new GameSDK_CFlowNode_RainProperties(pActInfo);
	}
};

REGISTER_FLOW_NODE("Environment:RainProperties", GameSDK_CFlowNode_RainProperties)
