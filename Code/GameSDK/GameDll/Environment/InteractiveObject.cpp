...
DECLARE_DEFAULT_COMPONENT_FACTORY(CInteractiveObjectEx, CInteractiveObjectEx)
DECLARE_DEFAULT_COMPONENT_FACTORY(CDeployableBarrier, CDeployableBarrier)
...
void CInteractiveObjectEx::InitClient (ChannelId channelId)
{
...
void CInteractiveObjectEx::PostInitClient (ChannelId channelId)
{
...
void CInteractiveObjectEx::SerializeSpawnInfo( TSerialize ser, IEntity * )
{
...
void CInteractiveObjectEx::SetChannelId (ChannelId id)
{
...
void CInteractiveObjectEx::StartUse( EntityId entityId )
{
	...
	if (pActor)
	{
		...
		if(m_bRemoveDecalsOnUse)
		{
			...
			if (IComponentRender *pRenderProxy = (IComponentRender*)GetEntity()->GetComponent<IComponentRender>().get())
			{
...
{
	const float angleLimitDot = (float)fsel(-interactionDataSet.m_interactionAngle, -1.0f, cos_tpl(interactionDataSet.m_interactionAngle));
