...
DECLARE_DEFAULT_COMPONENT_FACTORY(CC4Projectile,CC4Projectile)
...
void CC4Projectile::SerializeSpawnInfo( TSerialize ser ,IEntity *ent)
{
	BaseClass::SerializeSpawnInfo(ser,ent);
