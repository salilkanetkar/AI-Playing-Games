...
//------------------------------------------------------------------------
#if 0
IComponentPtr CWeaponSystem::CreateProjectile(IEntity *pEntity, SEntitySpawnParams &params, void *pUserData)
{
...
bool CWeaponSystem::ScanXML(XmlNodeRef &root, const char *xmlFile)
{
	...
	//classDesc.pComponentUserData = (void *)it->second;
	//classDesc.pComponentUserCreateFunc = &CreateProxy<CProjectile>;
