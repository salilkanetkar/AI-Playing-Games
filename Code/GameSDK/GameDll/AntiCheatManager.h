...
public:
  ...
  TCheatAssetGroup FindAssetTypeByWeight();
	...
	// IAntiCheatManager
	void FlagActivity(TCheatType, ChannelId, float, float, const char *) override { }
	void FlagActivity(TCheatType, ChannelId, float, const char *) override { }
	void FlagActivity(TCheatType, ChannelId, float, float) override { }
	void FlagActivity(TCheatType, ChannelId, float) override { }
	void FlagActivity(TCheatType, ChannelId) override { }
	void FlagActivity(TCheatType, ChannelId, const char *) override { }
