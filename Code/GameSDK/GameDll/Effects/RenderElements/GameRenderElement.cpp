...
// Description : Base class for all game render elements
...
// Desc: Constructor
//--------------------------------------------------------------------------------------------------
GameSDKCGameRenderElement::GameSDKCGameRenderElement()
{
...
//--------------------------------------------------------------------------------------------------
bool GameSDKCGameRenderElement::InitialiseGameRenderElement()
{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameRenderElement::ReleaseGameRenderElement()
{
	if(m_pREGameEffect)
	{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameRenderElement::UpdatePrivateImplementation()
{
	if(m_pREGameEffect)
	{
		m_pREGameEffect->SetPrivateImplementation(this);
...
//--------------------------------------------------------------------------------------------------
CREGameEffect* GameSDKCGameRenderElement::GetCREGameEffect()
{
