...
// Description : Manages effects for scene blur - The effect needs to be managed in 1 
//               global place to stop different game features fighting over setting the 
//               values
...
{
    GameSDKCGameEffect::Initialise(pGameEffectParams);
}
