...
// Description : Manages hud interference - The effect needs to be managed in 1 global 
//               place to stop different game features fighting over setting the values
...
void CHudInterferenceGameEffect::Update(float frameTime)
{
	...
	gEnv->p3DEngine->SetPostEffectParam( "HUD3D_Interference", m_interferenceScale );
	...
	gEnv->p3DEngine->SetPostEffectParamVec4( "HUD3D_InterferenceParams0", interferenceParams);
