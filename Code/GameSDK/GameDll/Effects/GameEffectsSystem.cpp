...
// Description : System to handle game effects, render nodes and render elements
...
//--------------------------------------------------------------------------------------------------
    ...
    int	GameSDKCGameEffectsSystem::s_currentDebugEffectId = 0;
...
// Desc: Static data
//--------------------------------------------------------------------------------------------------
GameSDKCGameEffectsSystem*	GameSDKCGameEffectsSystem::s_singletonInstance = NULL;
bool								GameSDKCGameEffectsSystem::s_hasLoadedData = false;
int									GameSDKCGameEffectsSystem::s_postEffectCVarNameOffset = 0;
//--------------------------------------------------------------------------------------------------
...
#if DEBUG_GAME_FX_SYSTEM
    static PodArray<GameSDKCGameEffectsSystem::SEffectDebugData>&	GetEffectDebugList()
	{
        static PodArray<GameSDKCGameEffectsSystem::SEffectDebugData>	effectDebugList;
...
GameSDKCGameEffectsSystem::GameSDKCGameEffectsSystem()
{
    ...
    RegisterSoftCodeLib(GameSDKIGameEffect::TLibrary::Instance());
	RegisterSoftCodeLib(IGameRenderNode::TLibrary::Instance());
    RegisterSoftCodeLib(GameSDKIGameRenderElement::TLibrary::Instance());
#endif
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::Reset()
{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::Initialise()
{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::LoadData()
{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::ReleaseData()
{
	if(s_hasLoadedData)
	{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::EnteredGame()
{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::RegisterDataLoadCallback(DataLoadCallback dataLoadCallback)
{
	if(dataLoadCallback)
	{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::RegisterDataReleaseCallback(DataReleaseCallback dataReleaseCallback)
{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::RegisterDataReloadCallback(DataReloadCallback dataReloadCallback)
{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::RegisterEnteredGameCallback(EnteredGameCallback enteredGameCallback)
{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::GameRenderNodeInstanceReplaced(void* pOldInstance, void* pNewInstance)
{
#ifdef SOFTCODE_ENABLED
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::GameRenderElementInstanceReplaced(void* pOldInstance, void* pNewInstance)
{
#ifdef SOFTCODE_ENABLED
	if(pOldInstance && pNewInstance)
	{
        GameSDKIGameRenderElement* pOldGameRenderElementInstance = (GameSDKIGameRenderElement*)pOldInstance;
        GameSDKIGameRenderElement* pNewGameRenderElementInstance = (GameSDKIGameRenderElement*)pNewInstance;
		...
		{
            GameSDKIGameRenderElementPtr* ppRenderElement = *iter;
			if(ppRenderElement)
			{
                GameSDKIGameRenderElementPtr& pRenderElement = *ppRenderElement;
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::PostEffectCVarCallback(ICVar* cvar)
{
...
//--------------------------------------------------------------------------------------------------
#ifdef SOFTCODE_ENABLED
void* GameSDKCGameEffectsSystem::CreateSoftCodeInstance(const char* pTypeName)
{
...
//--------------------------------------------------------------------------------------------------
#ifdef SOFTCODE_ENABLED
void GameSDKCGameEffectsSystem::RegisterSoftCodeLib(ITypeLibrary* pLib)
{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::RegisterGameRenderNode(IGameRenderNodePtr& pGameRenderNode)
{
#ifdef SOFTCODE_ENABLED
	for(TGameRenderNodeVec::iterator iter(m_gameRenderNodes.begin()); iter != m_gameRenderNodes.end(); ++iter)
	{
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::UnregisterGameRenderNode(IGameRenderNodePtr& pGameRenderNode)
{
#ifdef SOFTCODE_ENABLED
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::RegisterGameRenderElement(GameSDKIGameRenderElementPtr& pGameRenderElement)
{
#ifdef SOFTCODE_ENABLED
	for(TGameRenderElementVec::iterator iter(m_gameRenderElements.begin()); iter != m_gameRenderElements.end(); ++iter)
	{
		GameSDKIGameRenderElementPtr* ppIterRenderElement = *iter;
...
//--------------------------------------------------------------------------------------------------
void GameSDKCGameEffectsSystem::UnregisterGameRenderElement(GameSDKIGameRenderElementPtr& pGameRenderElement)
{
#ifdef SOFTCODE_ENABLED
...
//--------------------------------------------------------------------------------------------------
#if DEBUG_GAME_FX_SYSTEM
void GameSDKCGameEffectsSystem::DrawDebugDisplay()
{
	...
	if((g_pGameCVars->g_gameFXSystemDebug) && (debugEffectCount > 0))
	{
		...
		if(m_debugView==eGAME_FX_DEBUG_VIEW_EffectList)
		{
            ...
            GameSDKIGameEffect* pEffectListArray[EFFECT_LIST_COUNT] = {m_effectsToUpdate,m_effectsNotToUpdate};
			...
			{
                GameSDKIGameEffect* pCurrentEffect = pEffectListArray[l];
...
//--------------------------------------------------------------------------------------------------
#if DEBUG_GAME_FX_SYSTEM
GameSDKIGameEffect* GameSDKCGameEffectsSystem::GetDebugEffect(const char* pEffectName) const
{
	const int EFFECT_LIST_COUNT = 2;
    GameSDKIGameEffect* pEffectListArray[EFFECT_LIST_COUNT] = {m_effectsToUpdate,m_effectsNotToUpdate};
...
//--------------------------------------------------------------------------------------------------
#if DEBUG_GAME_FX_SYSTEM
void GameSDKCGameEffectsSystem::OnActivateDebugView(int debugView)
{
	switch(debugView)
	{
...
//--------------------------------------------------------------------------------------------------
#if DEBUG_GAME_FX_SYSTEM
void GameSDKCGameEffectsSystem::OnDeActivateDebugView(int debugView)
{
	switch(debugView)
	{
		case eGAME_FX_DEBUG_VIEW_Profiling:
...
//--------------------------------------------------------------------------------------------------
#if DEBUG_GAME_FX_SYSTEM
void GameSDKCGameEffectsSystem::RegisterEffectDebugData(	DebugOnInputEventCallback inputEventCallback,
