...
int CNetLerper::GetLerpError(const Vec3& errorToDesiredPos, const Vec3& lerpError) const
{
	...
	if (m_pPlayer)
	{
		...
		snapDistZ = (float)fsel(timeOnGround, m_settings->snapDistZInAir, snapDistZ);
	}
