...
// Description : Objectives for the predator game mode
...
//-------------------------------------------------------------------------
void CGameRulesObjective_Predator::PostInitClient (ChannelId channelId)
{
}
...
//-------------------------------------------------------------------------
int CGameRulesObjective_Predator::GetAutoAssignTeamId( ChannelId channelId )
{
...
//-------------------------------------------------------------------------
void CGameRulesObjective_Predator::OnClientDisconnect( ChannelId channelId, EntityId playerId )
{
...
bool CGameRulesObjective_Predator::EndGameIfOnlyOnePlayerRemains( ChannelId channelId )
{
	CGameLobby *pGameLobby = g_pGame->GetGameLobby();
	if (pGameLobby)
	{
