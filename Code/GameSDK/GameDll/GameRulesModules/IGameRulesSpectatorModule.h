...
class IGameRulesSpectatorModule
{
	...
	virtual bool GetModeFromChannelSpectatorMap(ChannelId channelId, int* outMode) const = 0;
	virtual void FindAndRemoveFromChannelSpectatorMap(ChannelId channelId) = 0;
