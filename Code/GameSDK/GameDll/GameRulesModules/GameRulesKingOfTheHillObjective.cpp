...
// Description : Implementation of a king of the hill objective (take and hold)
...
void CGameRulesKingOfTheHillObjective::ClearEntityAudio( SHoldEntityDetails *pDetails )
{
	...
	if(pEntity)
	{
		IComponentAudio *pIComponentAudio = (IComponentAudio*) pEntity->GetComponent<IComponentAudio>().get();
		if(pIComponentAudio)
		{
