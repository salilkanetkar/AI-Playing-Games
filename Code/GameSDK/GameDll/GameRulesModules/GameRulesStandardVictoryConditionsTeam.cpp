...
// Description : Standard game rules module to handle victory conditions
...
void CGameRulesStandardVictoryConditionsTeam::SendVictoryMessage( ChannelId channelId )
{
