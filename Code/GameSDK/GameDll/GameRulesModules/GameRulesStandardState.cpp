...
void CGameRulesStandardState::PostInit()
{
	...
	if (CGameLobby* pGameLobby = g_pGame->GetGameLobby())
	{
		...
		{
			const ChannelId channelId = (int)sessionNames.m_sessionNames[i].m_conId.m_uid;
...
bool CGameRulesStandardState::CheckInitialChannelPlayers()
{
	...
	if (CGameLobby* pGameLobby = g_pGame->GetGameLobby())
	{
		...
		{
			const ChannelId channelId = m_initialChannelIds[i];
...
bool CGameRulesStandardState::IsInitialChannelId( ChannelId channelId ) const
{
