...
// Description : Class for managing a series of SimpleEntityObjectives based on xml
//               parameterisation
...
//------------------------------------------------------------------------
void CGameRulesSimpleEntityBasedObjective::OnClientEnteredGame( ChannelId channelId, bool isReset, EntityId playerId )
{
	CGameRules *pGameRules = g_pGame->GetGameRules();
