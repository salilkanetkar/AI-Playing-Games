...
// Description: Objectives module for CTF
...
public:
	...
	virtual int GetAutoAssignTeamId(ChannelId channelId) { return 0; }
	...
	virtual void OnClientDisconnect(ChannelId channelId, EntityId playerId) { OnPlayerKilledOrLeft(playerId, 0); }
