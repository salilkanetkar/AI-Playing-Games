...
void CGameRulesStandardVictoryConditionsPlayer::SendVictoryMessage( ChannelId channelId )
{
	m_pGameRules->GetGameObject()->InvokeRMI(CGameRules::ClVictoryPlayer(), m_playerVictoryParams, eRMI_ToClientChannel, channelId);
}

void CGameRulesStandardVictoryConditionsPlayer::OnNewPlayerJoined( ChannelId channelId )
{
}
