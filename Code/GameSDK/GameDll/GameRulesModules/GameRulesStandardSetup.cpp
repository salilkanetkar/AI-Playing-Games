...
//------------------------------------------------------------------------
void CGameRulesStandardSetup::OnClientConnect(ChannelId channelId, bool isReset, const char* playerName, bool isSpectator)
{
...
void CGameRulesStandardSetup::AssignActorToTeam( IActor* pActor, ChannelId channelId )
{
...
void CGameRulesStandardSetup::OnActorJoinedFromSpectate( IActor* pActor, ChannelId channelId )
{
	AssignActorToTeam(pActor, channelId);
}
