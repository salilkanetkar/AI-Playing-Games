...
DECLARE_DEFAULT_COMPONENT_FACTORY(CJaw, CJaw)
...
CJaw::~CJaw()
{
	// since we are our own firing locator, we need to clear this out here
	// or else the baseclass will do stuff with it after our vtable is dead.
