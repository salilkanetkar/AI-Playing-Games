...
void CUIMultiPlayer::InitEventSystem()
{
	...
	m_pUIFunctions = pFlashUI->CreateEventSystem("MP", IUIEventSystem::eEST_SYSTEM_TO_UI);
	...
	m_pUIEvents = pFlashUI->CreateEventSystem("MP", IUIEventSystem::eEST_UI_TO_SYSTEM);
	...
	pFlashUI->RegisterModule(this, "CUIMultiPlayer");
}
