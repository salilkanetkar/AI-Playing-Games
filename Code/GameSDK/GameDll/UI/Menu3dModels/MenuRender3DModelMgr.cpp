...
// Description : Rendering of 3d models in menus
...
CMenuRender3DModelMgr::CMenuRender3DModelMgr()
{
	...
	{
		gEnv->p3DEngine->SetPostEffectParam("Post3DRenderer_Active",1.0f);
	}
...
CMenuRender3DModelMgr::~CMenuRender3DModelMgr()
{
	...
	if(s_instanceCount == 0)
	{
		...
		gEnv->p3DEngine->SetPostEffectParam("Post3DRenderer_Active",0.0f);
	}
...
void CMenuRender3DModelMgr::UpdateLightSettings(float frameTime)
{
	...
	gEnv->p3DEngine->SetPostEffectParamVec4("Post3DRenderer_Ambient", m_sceneSettings.ambientLight);
}//-------------------------------------------------------------------------------------------------
...
void CMenuRender3DModelMgr::UpdateEntities()
{
	...
	const bool bForceValue = true;
	gEnv->p3DEngine->SetPostEffectParam("Post3DRenderer_FOVScale", m_sceneSettings.fovScale);
}//-------------------------------------------------------------------------------------------------
...
void CMenuRender3DModelMgr::OnPreRender()
{
	if(!m_bReleaseMe)
	{
		...
		const bool bForceValue = true;
		gEnv->p3DEngine->SetPostEffectParam("Post3DRenderer_EdgeFadeScale", m_sceneSettings.flashEdgeFadeScale);
	}
}//-------------------------------------------------------------------------------------------------
