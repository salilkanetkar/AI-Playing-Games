...
void CUISettings::InitEventSystem()
{
	...
	m_pUIFunctions = pFlashUI->CreateEventSystem("Settings", IUIEventSystem::eEST_SYSTEM_TO_UI);
	...
	m_pUIEvents = pFlashUI->CreateEventSystem("Settings", IUIEventSystem::eEST_UI_TO_SYSTEM);
	...
	pFlashUI->RegisterModule(this, "CUISettings");
}
