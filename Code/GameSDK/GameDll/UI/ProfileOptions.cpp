...
bool CProfileOptions::WriteGameCfg()
{
	...
	AZ::IO::HandleType fileHandle = fxopen("@user@/game.cfg", "wb");
	if (fileHandle == AZ::IO::InvalidHandle)
		return false;


	AZ::IO::FPutS("-- [Game-Configuration]\r\n", fileHandle);
	AZ::IO::FPutS("-- Attention: This file is re-generated by the system! Editing is not recommended! \r\n\r\n", fileHandle);

	CCVarSink sink (this, fileHandle);
...
void CProfileOptions::CCVarSink::OnElementFound(ICVar *pCVar)
{
	...
	AZ::IO::FPutS(format.c_str(), m_fileHandle);
}
