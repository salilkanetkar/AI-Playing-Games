...
void CUIDialogs::InitEventSystem()
{
	...
	m_pUIFunctions = pFlashUI->CreateEventSystem("Dialogs", IUIEventSystem::eEST_SYSTEM_TO_UI);
	...
	m_pUIEvents = pFlashUI->CreateEventSystem("Dialogs", IUIEventSystem::eEST_UI_TO_SYSTEM);
