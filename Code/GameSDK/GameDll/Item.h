...
public:
	DECLARE_COMPONENT_TYPE("CItem",0x3360C9628E8847E1,0xA17A1CB51B9E73A1)
	struct SelectAction;
...
public:
	...
	virtual bool FilterView(struct SViewParams &viewParams) override;
	...
	virtual IWeapon *GetIWeapon() override { return 0; };
	virtual const IWeapon *GetIWeapon() const override { return 0; }

	virtual bool IsAccessory() override { return false; };

	virtual void SetOwnerId(EntityId ownerId) override;
	virtual EntityId GetOwnerId() const override;
  ...
  virtual void ResetOwner() ;
	...
	virtual Vec3 GetMountedDir() const override {return GetStats().mount_dir;}
	...
	virtual bool IsModifying() const override { return AreAnyItemFlagsSet(eIF_Modifying | eIF_Transitioning); }
  ...
  virtual void OnRepaired();
	...
	IComponentAudio *GetAudioProxy(bool create=false);
	IComponentRender *GetRenderProxy(bool create=false);
	IComponentPhysics *GetPhysicalProxy(bool create=false);
...
DECLARE_COMPONENT_POINTERS(CItem)
