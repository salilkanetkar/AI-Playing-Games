...
// Description : The internal representation of a missile within the hazard system.
...
//
void HazardDataProjectile::DebugRender (IPersistentDebug& debugRenderer) const
{
	if (!IsHazardAreaDefined())
	{
		return;
