...
// Description : This module provides a number of services for the Mastermind agent:
//               Resurrection
//
...
IEntity* MastermindModuleInstance::SpawnShieldEntity()
{
	...
	CGameObject* gameObject = (CGameObject*)(newEntity->GetComponent<IComponentUser>().get());
