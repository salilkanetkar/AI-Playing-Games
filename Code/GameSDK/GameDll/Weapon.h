...
public:
	...
	DECLARE_COMPONENT_TYPE("CWeapon", 0x788CDFD1AE1B427B, 0xB317609D5C80410B);
...
public:
	...
	virtual void InitClient (ChannelId channelId) { CItem::InitClient(channelId); };
  ...
  virtual void SetDestination(const Vec3& pos){ m_destination = pos; }
	...
	virtual void ReloadWeapon(bool force=false);
