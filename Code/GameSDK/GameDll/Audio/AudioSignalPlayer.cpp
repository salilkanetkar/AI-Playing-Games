...
{
	/*IComponentAudio* pProxy = CGameAudioUtils::GetEntityAudioProxy( entityID );
...
//		if(pIComponentAudio)
//		{
//			const bool bResult = pIComponentAudio->PlaySound(pSound);
//			if (!bResult)
//			{
//				pSound->Stop();
//				return INVALID_SOUNDID;
...
////////////////////////////////////////////////////////////////////////////
//
//ISound* CAudioSignalPlayer::GetSoundInterface( IComponentAudio* pProxy, tSoundID soundID ) const
//{
