...
DECLARE_DEFAULT_COMPONENT_FACTORY(CTurret, CTurret)
...
void CTurret::InitClient (ChannelId channelId)
{
...
void CTurret::PostInitClient (ChannelId channelId)
{
...
void CTurret::SerializeSpawnInfo( TSerialize serializer, IEntity * )
{
...
void CTurret::SetChannelId (ChannelId id)
{
...
void CTurret::InitTurretSoundManager()
{
	...
	m_pSoundManager.reset( new CTurretSoundManager( pSoundTable, pCharacterInstance, pIComponentAudio ) );
}
