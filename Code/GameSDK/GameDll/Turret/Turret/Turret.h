...
{
public:
	DECLARE_COMPONENT_TYPE("CTurret",0x81E57F2D6E9B496A,0xA82B1FA1743BA88D)
	CTurret();
	virtual ~CTurret();
	...
	virtual void FullSerialize( TSerialize serializer ) override;
	virtual bool NetSerialize( TSerialize serializer, EEntityAspects aspect, uint8 profile, int flags ) override;
	virtual void PostSerialize() override;
	virtual void SerializeSpawnInfo( TSerialize serializer , IEntity *) override;
	...
	virtual void PostUpdate( float frameTimeSeconds ) override;
...
DECLARE_COMPONENT_POINTERS(CTurret)
