...
{
	AZ::IO::HandleType cpFile = gEnv->pCryPak->FOpen(fileName, "r");
...
int CCodeCheckpointDebugMgr::GetLine( char * pBuff, AZ::IO::HandleType fp )
{	
	CRY_ASSERT(pBuff && (fp != AZ::IO::InvalidHandle));
