...
void CVTOLVehicleManager::OnPlayerEntered(EntityId playerId)
{
	...
	if(pEntity)
	{
		...
		gEnv->p3DEngine->SetPostEffectParam( "MotionBlur_DrawNearZRangeOverride", customDrawNearZRange );
	}
}
...
void CVTOLVehicleManager::OnPlayerExited(EntityId playerId)
{
	...
	if(pEntity)
	{
		...
		gEnv->p3DEngine->SetPostEffectParam( "MotionBlur_DrawNearZRangeOverride", 0.0f );
	}
}
