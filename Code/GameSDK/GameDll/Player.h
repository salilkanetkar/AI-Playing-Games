...
public:
	...
	static const NetworkAspectType ASPECT_STEALTH_KILL								= eEA_GameServerD; //E;
	static const NetworkAspectType ASPECT_INTERACTIVE_OBJECT						= eEA_GameClientJ; //K;
	
	static const NetworkAspectType ASPECT_VEHICLEVIEWDIR_CLIENT						= eEA_GameClientJ; // L;

	static const NetworkAspectType ASPECT_CURRENT_ITEM								= eEA_GameClientJ; // M;
	...
	DECLARE_COMPONENT_TYPE("CPlayer", 0xE12B47BB94E740A0, 0x887E373D226D67D7)
	CPlayer();
	virtual ~CPlayer();
  ...
  virtual void DisableStumbling();
	...
	{
		m_stats.zeroVelocityForTime = (float)fsel(time - m_stats.zeroVelocityForTime, time, m_stats.zeroVelocityForTime);
	}
