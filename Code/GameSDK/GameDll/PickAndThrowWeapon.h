...
// Note : not really a "weapon": is just the hands grabbing objects (barrels etc) and throwing them
...
public:
	...
	DECLARE_COMPONENT_TYPE("CPickAndThrowWeapon", 0x5111492C536B476D,0x815858697C83D6A9)
	CPickAndThrowWeapon();
