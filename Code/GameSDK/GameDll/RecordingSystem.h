...
public:
	...
	static EntityId NetIdToEntityId(EntityId netId);
...
#define REPLAY_EVENT_GUARD CRecordingSystem::SStackGuard __ReplayEventGuard__(CRecordingSystem::m_replayEventGuard);
	...
	void CloakEnable(IComponentRender* pRenderProxy, bool enable, bool fade);
	...
	EntityId EntityIdToNetId(EntityId entityId);
